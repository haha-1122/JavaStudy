...
public class Eleven_13 {

    public static void main(String args[]) throws Exception {
        SutdaDeck3 deck = new SutdaDeck3();
        deck.shuffle();
        Player4[] pArr = {
                new Player4("타짜", deck.pick(), deck.pick()),
                new Player4("고수", deck.pick(), deck.pick()),
                new Player4("물주", deck.pick(), deck.pick()),
                new Player4("중수", deck.pick(), deck.pick()),
                new Player4("하수", deck.pick(), deck.pick())
        };
        TreeMap rank = new TreeMap(new Comparator() {
            public int compare(Object o1, Object o2) {

                if (o1 instanceof Player4 && o2 instanceof Player4) {
                    Player4 s1 = (Player4) o1;
                    Player4 s2 = (Player4) o2;
...
class Player4 {
    ...
    Player4(String name, SutdaCard5 c1, SutdaCard5 c2) {
        this.name = name;
        this.c1 = c1;
        this.c2 = c2;
    }
